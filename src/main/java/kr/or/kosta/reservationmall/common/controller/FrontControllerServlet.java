package kr.or.kosta.reservationmall.common.controller;
...
import kr.or.kosta.reservationmall.common.view.View;
import kr.or.kosta.reservationmall.common.view.ViewResolver;
...
public class FrontControllerServlet extends HttpServlet {
	...
	Logger logger = Logger.getLogger(FrontControllerServlet.class);
...
//	private ControllerFactory controllerFactory;
	...
	public void init(ServletConfig config) throws ServletException {
		...
		try {
			controllerFactory = new XMLObjectFactory(config.getServletContext().getRealPath(configLocation));
		} catch (Exception e) {
